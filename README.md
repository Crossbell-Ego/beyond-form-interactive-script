...
## 遊戲內容與特色
* **第一章：裁員風暴**：面對 HR 夏凌的刁難與總經理蘇恬的質詢，提出改造部門的具體效率策略以求生存。
* **第二章：吞日黑幕**：調任核心專案組，與直屬副理余鋒烈共事，深入發掘暗中操控公司全體員工的科幻黑幕。
  * **【機緣卡】**：點擊後觸發人脈關係，自動透過海外分公司的內線直接建立數據對接管道。
  * **【事件卡】**：觸發總部辦公室網路流量限速 80% 突發事件，強迫面臨「發揮衝勁：人肉快遞硬碟」或「採取保守：配合限速分批傳輸」的對策考量，體驗不同的熱血/雷區回饋。
* **語音與立繪互動系統**：
  * **環境與配音整合**：遊戲在故事背景介紹（分頁二）和第一章過渡頁（分頁五）皆會播放高質感的開場白語音，並在各對話點同步播放角色專屬配音。
  * **立繪呼吸發光特效**：語音播放時，發言角色的立繪將會與語音同步，呈現慢速明暗呼吸發光動畫（1.2s 週期），加強互動劇本代入感。
